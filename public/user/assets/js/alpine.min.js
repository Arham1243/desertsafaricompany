(() => {
    ...
    function mt(e) {
            ...
            if (
                ...
                (e[o].type === "childList" &&
                    (e[o].addedNodes.forEach(
                        (s) => s.nodeType === 1 && t.add(s),
                    ),
                    e[o].removedNodes.forEach(
                        (s) => s.nodeType === 1 && r.add(s),
                    )),
                e[o].type === "attributes")
            ) {
                let s = e[o].target,
        ...
        for (let o of r) t.has(o) || Zt.forEach((s) => s(o));
        t.forEach((o) => {
...
`
    ...
    function X(e, t) {
        return typeof t == "object" && t !== null ? qn(e, t) : Un(e, t);
    }
    function qn(e, t) {
        let r = {};
        return (
    ...
    d(
        ...
        (e, { value: t, modifiers: r, expression: n }, { evaluate: i }) => {
            (typeof n == "function" && (n = i(n)),
                n !== !1 &&
                    (!n || typeof n == "boolean" ? Jn(e, r, t) : Gn(e, n, t)));
        },
    );
    function Gn(e, t, r) {
        (Or(e, me, ""),
        ...
        if (Ot(e))
            ...
            Number.isInteger(t)
                ...
                : !Array.isArray(t) &&
                  ...
                  ? (e.value = String(t))
                  : Array.isArray(t)
                    ? (e.checked = t.some((r) => Pr(r, e.value)))
                    : (e.checked = !!t);
    ...
    var di = Object.prototype.toString,
        ...
        Mt = (e) => Yr(e).slice(8, -1);
    var Ue = (e) =>
        fi(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e;
    var We = (e) => {
            let t = Object.create(null);
            return (r) => t[r] || (t[r] = e(r));
        },
        pi = /-(\w)/g,
        $s = We((e) => e.replace(pi, (t, r) => (r ? r.toUpperCase() : ""))),
        mi = /\B([A-Z])/g,
        js = We((e) => e.replace(mi, "-$1").toLowerCase()),
        ...
        if (t === "clear") s.forEach(c);
            ...
            switch ((r !== void 0 && c(s.get(r)), t)) {
                case "add":
                    V(e)
                        ? Ue(r) && c(s.get("length"))
                        : (c(s.get(Q)), oe(e) && c(s.get(It)));
                    break;
                case "delete":
                    V(e) || (c(s.get(Q)), oe(e) && c(s.get(It)));
                    break;
                case "set":
                    oe(e) && c(s.get(Q));
                    break;
    ...
    var bi = Rt("__proto__,__v_isRef,__isVue"),
        an = new Set(
    ...
    function cn(e = !1, t = !1) {
        return function (n, i, o) {
            ...
            if (
                i === "__v_raw" &&
                o === (e ? (t ? Fi : dn) : t ? ji : fn).get(n)
            )
                return n;
            let s = V(n);
            if (!e && s && ye(Xr, i)) return Reflect.get(Xr, i, o);
            let a = Reflect.get(n, i, o);
            return (qe(i) ? an.has(i) : bi(i)) || (e || M(n, "get", i), t)
                ? a
                : kt(a)
                  ? !s || !Ue(i)
                      ? a.value
    ...
    function Ai(e = !1) {
        return function (r, n, i, o) {
            let s = r[n];
            if (!e && ((i = _(i)), (s = _(s)), !V(r) && kt(s) && !kt(i)))
                return ((s.value = i), !0);
            let a = V(r) && Ue(n) ? Number(n) < r.length : ye(r, n),
                c = Reflect.set(r, n, i, o);
            return (
                r === _(o) &&
                    (a ? Dt(i, s) && U(r, "set", n, i, s) : U(r, "add", n, i)),
                c
            );
        };
    }
    ...
    var Ri = { get: wi, set: vi, deleteProperty: Oi, has: Ci, ownKeys: Ti },
        Mi = {
            get: Ei,
            set(e, t) {
                return (
    ...
    function Qr(e, t) {
        ...
        return (
            r.set(e, t),
            o ? Dt(t, s) && U(r, "set", e, t, s) : U(r, "add", e, t),
            this
        );
    }
    function en(e) {
    ...
    function zi(e) {
        return e.__v_skip || !Object.isExtensible(e) ? 0 : Bi(Mt(e));
    }
    function et(e) {
        return e && e.__v_isReadonly ? e : mn(e, !1, Ri, Li, fn);
    }
    function pn(e) {
        return mn(e, !0, Mi, $i, dn);
    }
    ...
    y(
        "refs",
        (e) => (
            e._x_refs_proxy || (e._x_refs_proxy = B(Ki(e))),
            e._x_refs_proxy
        ),
    );
    function Ki(e) {
    ...
    Sn.inline = (e, { value: t, modifiers: r, expression: n }) => {
        t &&
    ...
    function Qi(e) {
        return k ? (Be ? !0 : e.hasAttribute("data-has-alpine-state")) : !1;
    }
    ...
    function eo(e, t, r, n) {
        let i = (s) => typeof s == "object" && !Array.isArray(s),
            o = e;
        r((s) => {
            (ro(s) && s >= 0 && (s = Array.from(Array(s).keys(), (f) => f + 1)),
                s === void 0 && (s = []));
            let a = e._x_lookup,
                c = e._x_prevKeys,
                l = [],
            ...
            if (i(s))
                s = Object.entries(s).map(([f, g]) => {
                    ...
                    (n(
                        (S) => {
                            (u.includes(S) && E("Duplicate key on x-for", e),
                                u.push(S));
                        },
                        { scope: { index: f, ...b } },
                    ),
            ...
            for (let f = 0; f < u.length; f++) {
                ...
                if (b === -1) (c.splice(f, 0, g), p.push([Ee, f]));
                    ...
                    let S = c.splice(f, 1)[0],
                        O = c.splice(b - 1, 1)[0];
                    (c.splice(f, 0, O), c.splice(b, 0, S), h.push([S, O]));
                } else j.push(g);
                Ee = g;
            }
            ...
            for (let f = 0; f < j.length; f++)
                a[j[f]]._x_refreshXForScope(l[u.indexOf(j[f])]);
            o._x_prevKeys = u;
        });
    }
    function to(e) {
    ...
    z.setEvaluator(xt);
    z.setReactivityEngine({ reactive: et, effect: rn, release: nn, raw: _ });
    var Vt = z;
    window.Alpine = Vt;
    queueMicrotask(() => {
        Vt.start();
