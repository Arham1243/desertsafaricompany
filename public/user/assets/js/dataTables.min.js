...
!(function (n) {
    ...
    function nt(t) {
        ...
        for (var x = t, S = x.aoColumns, w = 0; w < S.length; w++) {
            var T = ct(x, [w], !1, !1);
            S[w].colEl.css("width", T).css("min-width", T);
        }
        i = t.oScroll;
        (("" === i.sY && "" === i.sX) || qt(t),
            G(t, null, "column-sizing", [t]));
    }
    function at(t, e) {
        t = it(t, "bVisible");
    ...
    function st(t) {
        ...
        if ("ssp" !== J(t))
            for (e = 0, n = u.length; e < n; e++) {
                if (((s = []), !(l = u[e]).sType && l._sManualType))
                ...
                var b = C.type.className[l.sType],
                    b =
                        (b && (ut(t.aoHeader, e, b), ut(t.aoFooter, e, b)),
                        C.type.render[l.sType]);
                if (b && !l._render) {
                    ((l._render = V.util.get(b)), (y = w = S = x = D = void 0));
                    for (
                        var y, D = t, x = e, S = D.aoData, w = 0;
                        w < S.length;
                        w++
                    )
                        S[w].nTr &&
    ...
    function qt(e) {
        ...
        if (e.scrollBarVis !== f && void 0 !== e.scrollBarVis)
            ...
            if (
                ...
                for (var h = null, p = 0; p < e.aiDisplay.length; p++) {
                    var g = e.aiDisplay[p],
                        g = e.aoData[g].nTr;
                    if (g) {
                        h = g;
            ...
            function (t, e) {
                ...
                function n() {
                    !(function t(e, n, a) {
                        ...
                        i = ae(e, "pagingContainer")(e, h);
                        u = n.find(_.activeElement).data("dt-idx");
                        n.empty().append(i);
                        void 0 !== u &&
                            n.find("[data-dt-idx=" + u + "]").trigger("focus");
                        h.length &&
                            1 < a.buttons &&
