...
<link href="{{ asset('user/assets/fonts/boxicons/boxicons.css?v=' . time()) }}" rel="stylesheet">
<link href="{{ asset('user/assets/css/style.css?v=' . time()) }}" rel="stylesheet">
<link href="{{ asset('user/assets/css/responsive.css?v=' . time()) }}" rel="stylesheet">
