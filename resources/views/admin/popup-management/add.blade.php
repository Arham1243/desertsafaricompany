...
@section('content')
    <div class="col-md-12">
        <div class="dashboard-content">
            {{ Breadcrumbs::render('admin.popups.create') }}
            ...
            <form action="{{ route('admin.popups.store') }}" method="POST" enctype="multipart/form-data" id="validation-form">
                @csrf
                <div class="row">
                    <div class="col-md-9">
                            ...
                            <div class="form-box">
                                ...
                                <div class="form-box__body">
                                    ...
                                    <div class="form-fields">
                                        ...
                                        <div class="repeater-table" x-data="{ urls: [{ value: '' }] }">
                                            ...
                                            <button type="button" class="themeBtn ms-auto" @click="urls.push({value: ''})">
