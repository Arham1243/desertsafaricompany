                                                ...
                                                <div class="form-fields">
                                                    ...
                                                    <div class="form-fields">
                                                        ...
                                                        <select multiple x-model="schema.localBusiness.paymentAccepted"
                                                            ...
                                                            <option value="Installment Payment">Installment Payment
                                                            </option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="repeater-table">
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tbody>
                                                                <template
                                                                    x-for="(item, index) in schema.localBusiness.sameAs"
                                                                    :key="index">
                                                                    <tr>
                                                                        <td>
                                                                            <input type="text"
                                                                        ...
                                                                        <td>
                                                                            <div class="d-flex gap-2">
                                                                                <button type="button"
                                                                                    ...
                                                                                    :disabled="schema.localBusiness.sameAs
                                                                                        .length === 1">
                                                        ...
                                                        <button type="button" class="themeBtn"
                                                            @click="addToNestedArray('localBusiness.sameAs')">Add
                                                            Link</button>
                                                    </div>
                                                </div>
                                            </div>
