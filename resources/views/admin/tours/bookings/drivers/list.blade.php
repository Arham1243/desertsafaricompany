...
@section('content')
    <div class="col-md-12">
        <div class="dashboard-content">
            {{ Breadcrumbs::render('admin.booking-drivers.index') }}
            <form id="bulkActionForm" method="POST"
                action="{{ route('admin.bulk-actions', ['resource' => 'booking-drivers']) }}">
                @csrf
                <div class="table-container universal-table">
                    <div class="custom-sec">
                        <div class="custom-sec__header">
                            ...
                            <a href="{{ route('admin.booking-drivers.create') }}" class="themeBtn">Add new</a>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-5">
                                ...
                                <tbody>
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.booking-drivers.edit', $item->id) }}"
