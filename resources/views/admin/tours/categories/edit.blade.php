                                ...
                                <div class="form-box__header d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div class="form-check form-switch" data-enabled-text="Enabled"
                                            data-disabled-text="Disabled">
                                            <input type="hidden" value="0"
                                                name="content[news_section][is_enabled]">
                                            <input data-toggle-switch class="form-check-input" type="checkbox"
                                                id="news_section" value="1" name="content[news_section][is_enabled]"
                                                x-model="enabled">
                                                ...
                                                <div class="col-lg-6 col-12 mb-4">
                                                    <div class="form-fields">
                                                        ...
                                                        <div class="field color-picker" data-color-picker-container>
                                                            <label for="title-color-picker" data-color-picker></label>
                                                            <input id="title-color-picker" type="hidden"
                                                                name="content[news_section][title_text_color]"
                                                                data-color-picker-input
                                                                value="{{ $newsContent->title_text_color ?? '#000000' }}"
                                                                inputmode="text" />

                                                            <input type="text" name="content[news_section][title]"
                                                    ...
                                                    <div class="form-fields">
                                                        ...
                                                        <div class="field color-picker" data-color-picker-container>
                                                            ...
                                                            <input id="sub-title-color-picker" type="hidden"
                                                                name="content[news_section][subTitle_text_color]"
                                                                data-color-picker-input
                                                                value="{{ $newsContent->subTitle_text_color ?? '#243064' }}"
                                                                inputmode="text" />

                                                            <input type="text" name="content[news_section][subTitle]"
                                                                placeholder=""
                                            ...
                                            <div class="form-fields">
                                                <div class="d-flex align-items-center gap-3 mb-3">
                                                    ...
                                                    <div class="form-check form-switch" data-enabled-text="Enabled"
                                                        data-disabled-text="Disabled">
                                                        <input type="hidden" value="0"
                                                            name="content[news_section][is_button_enabled]">
                                                        <input data-toggle-switch class="form-check-input" type="checkbox"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-fields">
                                                            ...
                                                            <div class="field color-picker" data-color-picker-container>
                                                                <label for="cta-btn-bg-color" data-color-picker></label>
                                                                <input id="cta-btn-bg-color" type="hidden"
                                                                    name="content[news_section][btn_background_color]"
                                                                    data-color-picker-input
                                                                    value="{{ $newsContent->btn_background_color ?? '#1c4d99' }}"
                                                                    data-error="Background Color" inputmode="text" />

                                                                <input type="text"
                                                                    name="content[news_section][btn_link]"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-fields">
                                                            ...
                                                            <div class="field color-picker" data-color-picker-container>
                                                                <label for="cta-btn-text-color" data-color-picker></label>
                                                                <input id="cta-btn-text-color" type="hidden"
                                                                    name="content[news_section][btn_text_color]"
                                                                    data-color-picker-input
                                                                    value="{{ $newsContent->btn_text_color ?? '#ffffff' }}"
                                                                    data-error="Text Color" inputmode="text" />

                                                                <input type="text"
                                                                    name="content[news_section][btn_text]"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-fields">
                                                            ...
                                                            <select data-max-items="1"
                                                                name="content[news_section][featured_news_id]" multiple
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-fields">
                                                            ...
                                                            <select data-max-items="3"
                                                                name="content[news_section][news_list_ids][]" multiple
                                                                class="field select2-select" placeholder="Select">
                                                                @foreach ($news as $item)
                                                                    <option value="{{ $item->id }}"
