                ...
                <div class="row" x-data="{ optionTab: 'general' }">
                    ...
                    <div class="col-md-9">
                        ...
                        <div x-show="optionTab === 'pricing'" class="pricing-options">
                            <div class="form-box">
                                ...
                                <div class="form-box__body">
                                    <div x-data="{ boxHeadingEnabled: false }" class="row mb-3">
                                    ...
                                    <div x-data="{ enabled: {{ old('tour.pricing.simple_pricing_enabled', 0) ? 'true' : 'false' }} }" class="row">
                                        <div class="col-12 mb-2">
                                            <div class="form-fields">
                                                <div class="d-flex align-items-center gap-3 mb-2">
                                                        ...
                                                        <div x-show="tourType === 'promo'">
                                                            <div class="form-fields">
                                                                ...
                                                                <div class="repeater-table" data-repeater>
                                                                    ...
                                                                    <button type="button" class="themeBtn ms-auto"
                                                                        @click="addRow()">Add <i class="bx bx-plus"></i>
                                                                    </button>
                                                                </div>
                                                                        ...
                                                                        <template x-for="(addon, index) in addons"
                                                                            ...
                                                                            <div class="border p-3 rounded mb-3">
                                                                                <div class="row g-3 align-items-center">
                                                                                    ...
                                                                                    <div
                                                                                        class="col-md-1 text-center mb-2">
                                                                                        <button type="button"
                                    ...
                                    <div class="col-12 mb-3" x-data="{ enableDiscountByPersons: '0' }">
                                        <div class="col-12 my-2">
                                            <div class="row">
                                                <div class="col-12 mb-2">
                                                    <div class="form-fields">
                                                    ...
                                                    <div class="form-fields">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="enable_discount_by_persons" value="1"
                    ...
                    <div x-show="optionTab === 'availability'" class="availability-options">
                        ...
                        <div class="form-box">
                            ...
                            <div class="form-box__body" x-data="{ advanceBooking: 0, openHours: 0, advanceBookingType: 'immediately' }">
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-12 mb-2">
                                            <div class="form-fields">
                        ...
                        <div class="form-box" x-data="{ enableCashPickup: 1 }">
                            <div class="form-box__header d-flex align-items-center gap-3">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div class="form-check form-switch" data-enabled-text="Enabled"
                                        ...
                                        <input data-toggle-switch class="form-check-input" type="checkbox"
                                            ...
                                            value="1" checked name="enable_cash_pickup" />
                    ...
                    <div x-show="optionTab === 'booking_additional'" class="availability-options">
                        <div class="form-box" x-data="{ enableBookingAdditional: 1, additionalType: '', activitiesType: '', activitiesMulitpleSelection: [] }">
                                ...
                                <div class="row mt-4" x-show="additionalType === 'activities'">
                                    ...
                                    <div class="col-12 mt-4" x-show="activitiesType === 'multiple_selection'">
                                        <div class="row">
                                            ...
                                            <div class="col-12 mt-4" x-show="activitiesMulitpleSelection.includes('meeting_point')">
                                                <div class="form-fields">
                            ...
                            @foreach ($cities as $cityObj)
                                <option value="{{ $cityObj->id }}" data-name="{{ $cityObj->name }}">
                                    {{ $cityObj->name }}
                                </option>
                            @endforeach
                        </select>
    ...
    <div class="form-check">
        ...
        <label class="form-check-label" for="pickup_home">
            Home
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <div class="form-fields">
                                                                    ...
                                                                    <select :name="`addOns[${index}][tour_ids][]`" multiple
                    ...
                    <div x-show="optionTab === 'badges'" class="badges-options">
                        <div class="form-box">
                            <div class="form-box__header">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 ">
                                                <div class="form-fields">
                                                    ...
                                                    <div x-data="{ icon: '{{ $jsonContent['status']['certified_tag']['icon'] ?? 'bx bx-badge-check' }}' }"
                    ...
                    <div class="form-box" x-data="{ enableBadge: 1 }">
    <div class="form-box__header d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="d-flex align-items-center gap-3">
                <div class="form-check form-switch" data-enabled-text="Enabled" data-disabled-text="Disabled">
                    <input data-toggle-switch class="form-check-input" type="checkbox" id="enable_badge_switch"
                        x-model="enableBadge" @change="enableBadge = enableBadge ? 1 : 0" value="1" checked
    ...
    <div class="form-box__body" x-show="enableBadge == 1">
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="form-fields">
                        <div class="d-flex align-items-center gap-3 mb-2">
                            <span class="title mb-0">Badge icon: <a class="p-0 ps-2 nav-link" href="//v2.boxicons.com"
                                    target="_blank">boxicons</a></span>
                        </div>
                        <div class="d-flex align-items-center gap-3">
                            <input type="text" name="tour[badge][icon_class]" class="field"
                                value="{{ old('tour[badge][icon_class]', 'bx bx-badge-check') }}" placeholder=""
                ...
                <div class="col-md-6 col-12">
                    <div class="form-fields">
                     ...
                     <div class="form-box" x-data="{ enableAuthor: 1 }">
    <div class="form-box__header d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-fields">
                                            ...
                                            <div class="d-flex align-items-center gap-3" x-data="{ iconClass: '{{ old('tour[status][author_config][icon_class]', 'bx bx-badge-check') }}' }">
                                                <div class="field color-picker" data-color-picker-container>
                                                    <label for="background-color-picker-author" data-color-picker></label>
                                                    <input id="background-color-picker-author" type="hidden"
                                                        data-color-picker-input
