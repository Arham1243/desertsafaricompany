                ...
                <div class="row" x-data="{ optionTab: 'general' }">
                    ...
                    <div x-show="optionTab === 'availability'" class="availability-options">
                        <div class="form-box">
                            ...
                            <div class="form-box__body" x-data="{ advanceBooking: 0, fixedDate: 0, openHours: 0, advanceBookingType: 'immediately' }">
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-12 mb-2">
                                            <div class="form-fields">
                        ...
                        <div class="form-box">
                            ...
                            <div class="form-box__body">
                                ...
                                <div x-data="{ badgeTagEnabled: false }" x-init="badgeTagEnabled = {{ old('tour.status.badge_tag.enabled', false) ? 'true' : 'false' }}">
                                    ...
                                    <div x-data="{ bookingRestrictionsEnabled: false }" x-init="bookingRestrictionsEnabled = {{ old('tour.status.booking_restrictions_badge.enabled', false) ? 'true' : 'false' }}">
                                                ...
                                                <div class="form-fields">
                                                    ...
                                                    <div class="field color-picker" data-color-picker-container>
                                                        ...
                                                        <input id="booking_restrictions_badge_bg_color" type="text"
                                                            ...
                                                            value="{{ old('tour.status.booking_restrictions_badge.background_color', '#ebeef1') }}"
                                                            inputmode="text">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-fields">
                                                    ...
                                                    <div class="field color-picker" data-color-picker-container>
                                                        ...
                                                        <input id="booking_restrictions_badge_text_color" type="text"
                                                            ...
                                                            value="{{ old('tour.status.booking_restrictions_badge.text_color', '#000000') }}"
                                                            inputmode="text">
                                                    </div>
                                                </div>
                                            </div>
