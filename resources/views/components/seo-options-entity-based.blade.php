@php
    ...
    $fieldName = fn($field) => $entity ? "{$entity}_{$field}" : "seo[{$field}]";

    $fieldValue = fn($field) => old($fieldName($field), $seo->{$fieldName($field)} ?? '');
@endphp
...
<div class="seo-options">
        ...
        <div class="form-box__body py-4">
            <div class="google-preview">
                ...
                <div class="google-preview__content">
                    <div class="heading" id="google_title">{{ $fieldValue('seo_title') }}</div>
                    <div class="description" id="google_desc">{{ $fieldValue('seo_description') }}</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-box d-none" id="seo_manager">
        ...
        <div class="form-box__body">
            <div class="row">
                <div class="col-md-7">
                    <div class="form-fields" x-data="{ seoIndex: '{{ old($fieldName('is_seo_index'), $fieldValue('is_seo_index')) }}' }">
                        <label class="title">Allow search engines to show this service in search results?</label>
                        <select name="{{ $fieldName('is_seo_index') }}" class="field" x-model="seoIndex">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link text-dark active" id="home-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="true">General Options</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link text-dark" id="profile-tab" data-bs-toggle="tab"
                                    data-bs-target="#profile" type="button" role="tab" aria-controls="profile"
                                    aria-selected="false">Share Facebook</button>
                            </li>
                            <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-content-wrapper">
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="home" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-fields col-md-4">
                                            <label class="title">Seo Feature Image:</label>
                                            <div class="upload" data-upload>
                                                <div class="upload-box-wrapper">
                                                    <div class="upload-box {{ empty($fieldValue('seo_featured_image')) ? 'show' : '' }}"
                                                        data-upload-box>
                                                        <input type="file"
                                                            name="{{ $fieldName('seo_featured_image') }}"
                                                    ...
                                                    <div class="upload-box__img {{ !empty($fieldValue('seo_featured_image')) ? 'show' : '' }}"
                                                        data-upload-img>
                                                        <button type="button" class="delete-btn" data-delete-btn><i
                                                                class='bx bxs-trash-alt'></i></button>
                                                        <a href="{{ asset($fieldValue('seo_featured_image') ?? 'admin/assets/images/loading.webp') }}"
                                                            class="mask" data-fancybox="gallery">
                                                            <img src="{{ asset($fieldValue('seo_featured_image') ?? 'admin/assets/images/loading.webp') }}"
                                            ...
                                            <div class="dimensions text-center mt-3"><strong>Dimensions:</strong> 1200
                                                &times; 630</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="profile" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="form-fields col-md-12">
                                            <label class="title">Facebook Title:</label>
                                            <input type="text" name="{{ $fieldName('fb_title') }}" class="field"
                                                value="{{ $fieldValue('fb_title') }}" placeholder="Title">
                                            @error($fieldName('fb_title'))
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-fields col-md-12">
                                            <label class="title">Facebook Description:</label>
                                            <textarea name="{{ $fieldName('fb_description') }}" class="field" rows="3"
                                                placeholder="Enter Description...">{{ $fieldValue('fb_description') }}</textarea>
                                            @error($fieldName('fb_description'))
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-fields col-md-4">
                                            <label class="title">Facebook Feature Image:</label>
                                            <div class="upload" data-upload>
                                                <div class="upload-box-wrapper">
                                                    <div class="upload-box {{ empty($fieldValue('fb_featured_image')) ? 'show' : '' }}"
                                                        data-upload-box>
                                                        <input type="file"
                                                            name="{{ $fieldName('fb_featured_image') }}"
                                                    ...
                                                    <div class="upload-box__img {{ !empty($fieldValue('fb_featured_image')) ? 'show' : '' }}"
                                                        data-upload-img>
                                                        <button type="button" class="delete-btn" data-delete-btn><i
                                                                class='bx bxs-trash-alt'></i></button>
                                                        <a href="{{ asset($fieldValue('fb_featured_image') ?? 'admin/assets/images/loading.webp') }}"
                                                            class="mask" data-fancybox="gallery">
                                                            <img src="{{ asset($fieldValue('fb_featured_image') ?? 'admin/assets/images/loading.webp') }}"
                                                                alt="Uploaded Image" class="imgFluid"
                                                                data-upload-preview>
                                                        </a>
                                                    </div>
                                ...
                                <div class="tab-pane fade" id="contact" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="form-fields col-md-12">
                                            <label class="title">Twitter Title:</label>
                                            <input type="text" name="{{ $fieldName('tw_title') }}" class="field"
                                                value="{{ $fieldValue('tw_title') }}" placeholder="Title">
                                            @error($fieldName('tw_title'))
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-fields col-md-12">
                                            <label class="title">Twitter Description:</label>
                                            <textarea name="{{ $fieldName('tw_description') }}" class="field" rows="3"
                                                placeholder="Enter Description...">{{ $fieldValue('tw_description') }}</textarea>
                                            @error($fieldName('tw_description'))
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-fields col-md-4">
                                            <label class="title">Twitter Feature Image:</label>
                                            <div class="upload" data-upload>
                                                <div class="upload-box-wrapper">
                                                    <div class="upload-box {{ empty($fieldValue('tw_featured_image')) ? 'show' : '' }}"
                                                        data-upload-box>
                                                        <input type="file"
                                                            name="{{ $fieldName('tw_featured_image') }}"
                                                    ...
                                                    <div class="upload-box__img {{ !empty($fieldValue('tw_featured_image')) ? 'show' : '' }}"
                                                        data-upload-img>
                                                        <button type="button" class="delete-btn" data-delete-btn><i
                                                                class='bx bxs-trash-alt'></i></button>
                                                        <a href="{{ asset($fieldValue('tw_featured_image') ?? 'admin/assets/images/loading.webp') }}"
                                                            class="mask" data-fancybox="gallery">
                                                            <img src="{{ asset($fieldValue('tw_featured_image') ?? 'admin/assets/images/loading.webp') }}"
                                                                alt="Uploaded Image" class="imgFluid"
                                                                data-upload-preview>
                                                        </a>
                                                    </div>
                                ...
                                <div class="tab-pane fade" id="canonical" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="form-fields col-md-12">
                                            <label class="title">Canonical:</label>
                                            <input type="text" name="{{ $fieldName('canonical') }}"
                                                class="field" value="{{ $fieldValue('canonical') }}"
                                                placeholder="Enter URL">
                                            @error($fieldName('canonical'))
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    </div>
