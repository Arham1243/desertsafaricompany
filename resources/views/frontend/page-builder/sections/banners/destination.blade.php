        ...
        <div class=container>
            <div class="row justify-content-between">
                ...
                <div class=col-md-8>
                    ...
                    <div
                        class="row g-0 {{ isset($content->destination_style_type) && $content->destination_style_type === 'carousel' ? 'five-items-slider' : '' }}  {{ $content->destination_style_type === 'normal' && $content->destination_style_type === 'normal' ? 'row-cols-1 row-cols-md-3 row-cols-lg-3 row-cols-xl-5' : '' }}">
