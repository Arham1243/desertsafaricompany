            ...
            <div class="row">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">desert-safari-dubai</li>
                    </ol>
                </nav>
                <div class="col-md-8">
                    <h2 class="blog-details__mainHeading">
                        Dubai’s Best Desert Safaris: Adventure and Luxury Combined
                    </h2>
